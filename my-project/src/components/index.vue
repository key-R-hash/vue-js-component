      ...
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <div id="myform">
            ...
            <ul class="w-100" v-for="log in current"  :key="log.id">
              <li class="w-100 float-left" style="list-style: none">
                  <h1  class="float-left">
                    <a style="text-decoration:none;color : black"  :href="'post?id=' + log.id">
                      {{log.title}}
                    </a>
                  </h1>
                   <a class="bg-info float-right pt-1 pb-1 pr-3 pl-3 rounded" style="color:black;text-decoration:none" :href="'update?id=' + log.id">edit</a>
              </li>
          ...
          <nav class="blog-pagination float-left w-100">
            <a class="btn btn-outline-primary" id="newer">Newer</a>
            <a class="btn btn-outline-secondary" id="older">Older</a>
          </nav>
...
$(document).ready(function () {
  ...
  $('#newer').click(function () {
    var page = get('page')
    if (page === '1') {
      location.href = 'index?per=3&page=' + page
    } else {
      var oldpage = page - 1
      location.href = 'index?per=3&page=' + oldpage
    }
  })
  $('#older').click(function () {
    var page = get('page')
    var newpage = Number(page) + Number(1)
    location.href = 'index?per=3&page=' + newpage
  })
})
