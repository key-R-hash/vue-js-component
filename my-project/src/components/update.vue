      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            <a class="btn btn-sm btn-outline-secondary mr-2" id="logout" @click="logout" href="#">Logout</a>
                ...
                <form method="post" onsubmit="return false">
                  <div v-for="log in log" :key="log.id">
                    ...
                    <div class="form-group">
                        ...
                        <textarea v-model="body" name="body" class="form-control tinymce"></textarea>

                    </div>

                    <div class="form-group">
                    <button @click="update" type="submit" class="btn btn-primary">Update</button>
                    <button @click="del" type="button" class="btn btn-primary">Delete</button>
                    </div>
                  </div>
                  <h1>
                    <div v-if="current !==  ''" class="alert alert-primary">{{current}}</div>
...
export default {
  ...
  methods: {
    update () {
      axios({
        ...
        .then(response => {
          ...
          this.error = ''
          this.current = response.data.message
        })
        .catch(error => {
          this.current = ''
    ...
    set () {
      axios
        .get('http://127.0.0.1:8000/api/posts' + '/' + get('id'), {
          headers: {
            Authorization: localStorage.getItem('storedData')
          }
        })
